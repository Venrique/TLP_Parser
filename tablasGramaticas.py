from re import A
from tablasGramaticaCopia import ZAritm
...
tablaDoWhile = [
    #SDoWhile
    [SDoWhile, 'eof', None],
    [SDoWhile, 'HACER', ['HACER', 'LLAVE_IZQ', 'GRAMATICA_INSTRUCCION', 'LLAVE_DER', 'BUCLE_MIENTRAS', 'PAREN_IZQ', 'GRAMATICA_OP_LOG', 'PAREN_DER', 'PUNTO_COMA']],
    [SDoWhile, 'LLAVE_IZQ', None],
    [SDoWhile, 'GRAMATICA_INSTRUCCION', None],
    [SDoWhile, 'LLAVE_DER', None],
    [SDoWhile, 'BUCLE_MIENTRAS', None],
    [SDoWhile, 'PAREN_IZQ', None],
    [SDoWhile, 'GRAMATICA_OP_LOG', None],
    [SDoWhile, 'PAREN_DER', None],
    [SDoWhile, 'PUNTO_COMA', None],
...
tablaFor = [
    #SFor
    [SFor, 'eof', None],
    [SFor, 'BUCLE_PARA', ['BUCLE_PARA', 'PAREN_IZQ', 'GRAMATICA_DECLARAR_VAR', 'PUNTO_COMA', 'GRAMATICA_OP_LOG', 'PUNTO_COMA', 'GRAMATICA_DEF_VAR', 'PAREN_DER', 'LLAVE_IZQ', 'GRAMATICA_INSTRUCCION', 'LLAVE_DER']], 
    [SFor, 'PAREN_IZQ', None],
    [SFor, 'GRAMATICA_DECLARAR_VAR', None],
    [SFor, 'PUNTO_COMA', None],
    [SFor, 'GRAMATICA_OP_LOG', None],
    [SFor, 'PUNTO_COMA', None],
    [SFor, 'GRAMATICA_DEF_VAR', None],
    [SFor, 'PAREN_DER', None],
    [SFor, 'LLAVE_IZQ', None],
    [SFor, 'GRAMATICA_INSTRUCCION', None],
    [SFor, 'LLAVE_DER', None],
]
'''